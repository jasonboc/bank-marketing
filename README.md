...
# Next Steps
Now we can use our model to develop a new marketing strategy. Then the new phone call campaign strategy will be: only call users which my random forest model predicts positive.
